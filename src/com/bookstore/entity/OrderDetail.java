...
@NamedQueries({
	@NamedQuery(name = "BookOrder.countByBook", query = "SELECT COUNT(*) FROM OrderDetail od WHERE od.book.bookId = :bookId"),
	@NamedQuery(name = "OrderDetail.bestSellingBook", query = "SELECT od.book FROM OrderDetail od GROUP BY od.book.bookId "
